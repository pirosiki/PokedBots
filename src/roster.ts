...
export const ROSTER: Record<string, BotEntry[]> = {
  ...
  Junker: [
    ...
    { token: 8626, name: "#8626", terrain: "MetalRoads" },
  ...
  Scrap: [
    ...
    { token: 7814, name: "#7814", terrain: "ScrapHeaps" },
  ],
};
